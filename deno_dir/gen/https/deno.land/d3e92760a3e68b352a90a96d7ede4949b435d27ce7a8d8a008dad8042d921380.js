 ...
 */ function factory(stack = []) {
    const colors1 = function(str1, ...args) {
        if (str1) {
            ...
            return stack.reduce((str, name1, index)=>index === lastIndex ? stdColors[name1](str, ...args) : stdColors[name1](str), str1);
        }
