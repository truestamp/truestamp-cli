 ...
 */ export class PreparedQuery {
   ...
   */ constructor(wasm, stmt, openStatements){
    ...
    makeRowObject(row) {
        ...
        const obj1 = row.reduce((obj, val, idx)=>{
