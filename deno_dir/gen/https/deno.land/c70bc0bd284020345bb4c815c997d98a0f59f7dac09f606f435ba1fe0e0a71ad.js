...
export class Command {
   ...
   */ parseFlags(args, env) {
    ...
    /** Parse argument type. */ parseType(type1) {
    ...
    /** Validate environment variables. */ async parseEnvVars() {
        ...
        for (const env of envVars){
            ...
            if (name1) {
                ...
                if (env.details.list) {
                    const values = Deno.env.get(name1)?.split(env.details.separator ?? ",") ?? [
                        ""
                    ];
