...
import { parse } from "https://deno.land/std@0.165.0/path/mod.ts";
import {
  copy,
  readAllSync,
...
import { CompletionsCommand } from "https://deno.land/x/cliffy@v0.25.4/command/completions/mod.ts";
import { HelpCommand } from "https://deno.land/x/cliffy@v0.25.4/command/help/mod.ts";
import {
  Command,
  EnumType,
  ValidationError,
...
export type { ITypeInfo } from "https://deno.land/x/cliffy@v0.25.4/flags/mod.ts";
