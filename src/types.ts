...
// ^ prevent deno fmt from reformatting this file if it is copied into a project
...
export const BetterUptimeResponseDataSchema = z.object({
  id: z.string(),
  type: z.string(),
  attributes: z.object({
...
export type BetterUptimeResponseData = z.infer<
  typeof BetterUptimeResponseDataSchema
>

export const BetterUptimeResponseSchema = z.object({
  data: z.array(BetterUptimeResponseDataSchema),
})

export type BetterUptimeResponse = z.infer<typeof BetterUptimeResponseSchema>
